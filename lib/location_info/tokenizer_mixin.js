...
exports.assign = function (tokenizer) {
    ...
    function attachLocationInfo(token) {
        ...
        token.location = {
            ...
            startByteOffset: tokenStartByteOffset,
            endOffset: -1,
            endByteOffset: -1
        };
    }
    ...
    tokenizer._emitCurrentToken = function () {
        ...
        if (this.currentCharacterToken) {
            ...
            this.currentCharacterToken.location.endByteOffset = this.currentToken.location.startByteOffset;
        }


        this.currentToken.location.endOffset = this.preprocessor.pos + 1;
        this.currentToken.location.endByteOffset = this.preprocessor.bytePos + 1;
    ...
    tokenizer._emitCurrentCharacterToken = function () {
        ...
        if (this.currentCharacterToken && this.currentCharacterToken.location.endByteOffset === -1)
            this.currentCharacterToken.location.endByteOffset = this.preprocessor.bytePos;
    ...
    Object.keys(tokenizerProto.MODE)
        ...
        .forEach(function (state) {
            tokenizer[state] = function (cp) {
                ...
                tokenStartByteOffset = this.preprocessor.bytePos;
                tokenLine = line;
                tokenCol = col;
